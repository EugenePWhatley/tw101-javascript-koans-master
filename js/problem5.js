...
function newspaperAd(originalAd){
    changeElementText("#originalAd", originalAd);
    var hindi = originalAd[0];
    var urdu = originalAd[1];
    var english = originalAd[2];
    var updatedAd = " ";
    ...
    var numOfWords = hindi.length + urdu.length + english.length;
    changeElementText("#correctedAd", updatedAd);
    changeElementText("#numOfWords", numOfWords);
}